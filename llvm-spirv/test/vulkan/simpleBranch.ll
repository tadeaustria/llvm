...
if.then.i:                                        ; preds = %entry
  ...
  %2 = load i32 addrspace(10)*, i32 addrspace(10)* addrspace(10)* getelementptr inbounds (%struct._ZTS8_arg_0_t._arg_0_t, %struct._ZTS8_arg_0_t._arg_0_t addrspace(10)* @_arg_0, i64 0, i32 0), align 8, !tbaa !13
  ...
  %ptridx.i.i = getelementptr inbounds i32, i32 addrspace(10)* %2, i64 %add6.1.i.i.i
